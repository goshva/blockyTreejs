...
Blockly.Blocks["draw_move"] = {
  init: function () {
    ...
    this.setColour(160);
    this.appendValueInput("DISTANCE").setCheck("Number").appendTitle("move");
...
Blockly.Blocks["draw_say"] = {
  init: function () {
    this.setColour(160);
    this.appendValueInput("value").setCheck("String").appendTitle("say");
...
Blockly.Blocks["draw_nickname"] = {
  init: function () {
    this.setColour(160);
    this.appendValueInput("value").setCheck("String").appendTitle("nickname");
...
Blockly.Blocks["draw_turn"] = {
  init: function () {
    this.setHelpUrl("http://www.w3schools.com/jsref/jsref_length_string.asp");
    this.setColour(160);
    this.appendValueInput("ANGLE").setCheck("Number").appendTitle("turn");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
